...
[![PHP Version](https://badgen.net/packagist/php/ghostwriter/craft?color=777BB4)](https://www.php.net/supported-versions)
[![Packagist Downloads](https://badgen.net/packagist/dt/ghostwriter/craft?color=F28D1A)](https://packagist.org/packages/ghostwriter/craft)
...
[![Sponsors via GitHub](https://img.shields.io/github/sponsors/ghostwriter?label=Sponsor+@ghostwriter/craft&logo=GitHub+Sponsors)](https://github.com/sponsors/ghostwriter)
...
``` bash
composer require ghostwriter/craft
```
...
- [All Contributors](https://github.com/ghostwriter/craft/contributors)
